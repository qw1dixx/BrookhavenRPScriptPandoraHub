...
local Window = Library.CreateLib("Quake Hub | Brookhaven 🏡RP", "Sentinel")
...
MainSection:NewToggle("Спам С4", "сирия момент", function(state)
    if state then
...
MainSection:NewButton("Разблокировать некоторые премиум функции", "я багати робакс с премиумом", function()
    loadstring(game:HttpGet('https://raw.githubusercontent.com/IceMael7/AvatarUnlocker/main/IceHub'))()
end)

MainSection:NewButton("Убить игроков", "Инструкции: заходите в предметы и используйте корзину, затем вставляете скрипт, быстро заставляете игрока сесть в корзину, вставляете скрипт до того, как игрок выпрыгнет", function()
...
MainSection:NewButton("Прыжки по воздуху", "прыг прыг", function()
...
if _G.infinJumpStarted == nil then
	...
	--Notifies readiness
	game.StarterGui:SetCore("SendNotification", {Title="Quake Hub | Brookhaven 🏡RP"; Text="Успешно загружено"; Duration=5;})
...
MainSection:NewToggle("Телепорт по клику (Ctrl + ЛКМ)", "зе варудо", function(state)
    if state then
        ...
        --Just toggle instead of re-executing the script
            ...
            if _G.WRDClickTeleport then
                game.StarterGui:SetCore("SendNotification", {Title="Quake Hub | Brookhaven 🏡RP"; Text="Телепорт по клику включён"; Duration=5;})
            else
                game.StarterGui:SetCore("SendNotification", {Title="Quake Hub | Brookhaven 🏡RP"; Text="Телепорт по клику выключен"; Duration=5;})
            end
        end
    else
        if _G.WRDClickTeleport == nil then
...
MainSection:NewToggle("Спам С4", "...", function(state)
    if state then
        local n = game:GetService("Players").LocalPlayer.Name
local mt = getrawmetatable(game)
local old = mt.__namecall
...
MainSection:NewButton("Комманды (IY FE)", "я админ бойтесь меня", function()
    loadstring(game:HttpGet('https://raw.githubusercontent.com/EdgeIY/infiniteyield/master/source'))()
end)

MainSection:NewSlider("Скорость", "флэш 777666228", 200, 0, function(s) -- 500 (MaxValue) | 0 (MinValue)
    game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = s
end)

MainSection:NewSlider("Сила Прыжка", "пружина", 500, 0, function(s) -- 500 (MaxValue) | 0 (MinValue)
    game.Players.LocalPlayer.Character.Humanoid.JumpPower = s
end)

MainSection:NewButton("ВХ", "ВоллХак", function()
